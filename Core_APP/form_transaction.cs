...
namespace cosmesticClinic.Core_APP
{
    public partial class form_transaction : Form
    {
        ...
        public void getAllTransaction()
        {
            ...
            try
            {
                string details = "SELECT (id) as [ID],(invoice_number) as [Invoice Number],(total_item) as [Total Item],(total_amount) as [Total Amount]" +
                    ",(staff_name) as [Staff],(payment_mode) as [Pyament Mode],(trans_date) as [Date],(trans_time) as [Time] from tbl_transaction  order by invoice_number desc ";
